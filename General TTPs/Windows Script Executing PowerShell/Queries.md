...
and FileName in~ ("powershell.exe", "powershell_ise.exe")
...
## TTP hunt
```
event_platform=win event_simpleName=ProcessRollup2 ParentBaseFileName IN ("cscript.exe", "wscript.exe") AND FileName IN ("powershell.exe", "powershell_ise.exe")
